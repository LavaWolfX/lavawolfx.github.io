...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005d2a5d3d000000003cb7ebf6(
...
class phpbbtemplatetwiglexer_000000005d2a5d3d000000003cb7ebf6 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c2da5eda35b4661071842 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c2da5eda35bc354135799 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c2da5eda359c964451817 = array(
    ...
    {
        $this->initializer5c2da5eda35bc354135799 && ($this->initializer5c2da5eda35bc354135799->__invoke($valueHolder5c2da5eda35b4661071842, $this, 'set_environment', array('env' => $env), $this->initializer5c2da5eda35bc354135799) || 1) && $this->valueHolder5c2da5eda35b4661071842 = $valueHolder5c2da5eda35b4661071842;

        return $this->valueHolder5c2da5eda35b4661071842->set_environment($env);
    }
    ...
    {
        $this->initializer5c2da5eda35bc354135799 && ($this->initializer5c2da5eda35bc354135799->__invoke($valueHolder5c2da5eda35b4661071842, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c2da5eda35bc354135799) || 1) && $this->valueHolder5c2da5eda35b4661071842 = $valueHolder5c2da5eda35b4661071842;

        return $this->valueHolder5c2da5eda35b4661071842->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c2da5eda35bc354135799 && ($this->initializer5c2da5eda35bc354135799->__invoke($valueHolder5c2da5eda35b4661071842, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c2da5eda35bc354135799) || 1) && $this->valueHolder5c2da5eda35b4661071842 = $valueHolder5c2da5eda35b4661071842;

        return $this->valueHolder5c2da5eda35b4661071842->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c2da5eda35bc354135799 = $initializer;
    }
    ...
    {
        $this->initializer5c2da5eda35bc354135799 && ($this->initializer5c2da5eda35bc354135799->__invoke($valueHolder5c2da5eda35b4661071842, $this, '__get', array('name' => $name), $this->initializer5c2da5eda35bc354135799) || 1) && $this->valueHolder5c2da5eda35b4661071842 = $valueHolder5c2da5eda35b4661071842;

        if (isset(self::$publicProperties5c2da5eda359c964451817[$name])) {
            return $this->valueHolder5c2da5eda35b4661071842->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c2da5eda35b4661071842;
    ...
    {
        $this->initializer5c2da5eda35bc354135799 && ($this->initializer5c2da5eda35bc354135799->__invoke($valueHolder5c2da5eda35b4661071842, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c2da5eda35bc354135799) || 1) && $this->valueHolder5c2da5eda35b4661071842 = $valueHolder5c2da5eda35b4661071842;
    ...
    {
        $this->initializer5c2da5eda35bc354135799 && ($this->initializer5c2da5eda35bc354135799->__invoke($valueHolder5c2da5eda35b4661071842, $this, '__isset', array('name' => $name), $this->initializer5c2da5eda35bc354135799) || 1) && $this->valueHolder5c2da5eda35b4661071842 = $valueHolder5c2da5eda35b4661071842;
    ...
    {
        $this->initializer5c2da5eda35bc354135799 && ($this->initializer5c2da5eda35bc354135799->__invoke($valueHolder5c2da5eda35b4661071842, $this, '__unset', array('name' => $name), $this->initializer5c2da5eda35bc354135799) || 1) && $this->valueHolder5c2da5eda35b4661071842 = $valueHolder5c2da5eda35b4661071842;
    ...
    {
        $this->initializer5c2da5eda35bc354135799 && ($this->initializer5c2da5eda35bc354135799->__invoke($valueHolder5c2da5eda35b4661071842, $this, '__clone', array(), $this->initializer5c2da5eda35bc354135799) || 1) && $this->valueHolder5c2da5eda35b4661071842 = $valueHolder5c2da5eda35b4661071842;

        $this->valueHolder5c2da5eda35b4661071842 = clone $this->valueHolder5c2da5eda35b4661071842;
    }

    public function __sleep()
    {
        $this->initializer5c2da5eda35bc354135799 && ($this->initializer5c2da5eda35bc354135799->__invoke($valueHolder5c2da5eda35b4661071842, $this, '__sleep', array(), $this->initializer5c2da5eda35bc354135799) || 1) && $this->valueHolder5c2da5eda35b4661071842 = $valueHolder5c2da5eda35b4661071842;

        return array('valueHolder5c2da5eda35b4661071842');
    }
    ...
    {
        return $this->initializer5c2da5eda35bc354135799;
    }
    ...
    {
        return $this->initializer5c2da5eda35bc354135799 && ($this->initializer5c2da5eda35bc354135799->__invoke($valueHolder5c2da5eda35b4661071842, $this, 'initializeProxy', array(), $this->initializer5c2da5eda35bc354135799) || 1) && $this->valueHolder5c2da5eda35b4661071842 = $valueHolder5c2da5eda35b4661071842;
    }
    ...
    {
        return null !== $this->valueHolder5c2da5eda35b4661071842;
    }
    ...
    {
        return $this->valueHolder5c2da5eda35b4661071842;
    }
